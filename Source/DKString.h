...
DK_API DKRange     DKStringGetRangeOfCharacters( DKStringRef _self, DKStringRef characters );
DK_API DKRange     DKStringGetRangeOfCharactersInRange( DKStringRef _self, DKStringRef characters, DKRange searchRange );
